...
//Person
public class Program14 {//class name
    String firstName;
    String lastName;
    int age;

    public static void main(String[] args) {
        Program14 s = new Program14();//calling object
        ...
        s.setFirstName("Bella"); // firstName is set to Bella
        s.setAge(17);
        System.out.println("fullName= " + s.getFullName());//print statement
        System.out.println("teen= " + s.isTeen());//print statement
        s.setLastName("Shah"); // lastName is  Shah
